...
- `.agents/skills/rayfin/SKILL.md` — authoritative Rayfin context (verbatim, Microsoft-managed).
- `.agents/skills/spreadsheet-to-datamodel/SKILL.md` — turn a user's CSV/XLSX/XLSM into Rayfin
  entities. Load it whenever the task is "build a data model from a spreadsheet." It runs a Python
  profiler for deterministic type/relationship inference, then has you author `rayfin/data/*.ts`.
